...
| **Letter Composer** | 自然书写 | 不套用模板，而是根据对话本身的节奏，自然地展开倾听、理解与延伸 |
...
每一轮回应都是自然流淌的对话——不按固定模板，而是根据当下的语境：

- 先被听见：你的话会被温柔地映照回来
- 试探性理解：情绪、假设、张力被轻轻呈现；随时可以说「不对」
- 保持开放：用问题而非答案，把意义留给你自己

对话会跟随你的节奏，大约 **四轮** 后，会轻声问：
...
>
> 这里面像是有几股力量：一种耗竭感，一个关于「应该随时在线」的隐藏假设，还有休息的需要与被期待立刻可用之间的拉扯。
>
> 哪一部分最先触碰到你？
